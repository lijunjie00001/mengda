...
import MYyouhuijuanList from './MyyouhuijuanList'
import ASText from '../../components/ASText'
@containers()
export default class MyyouhuijuanPage extends Component{
    static propTypes = {
    ...
    renderListViewWithType(type){
        ...
        return (
            <View style={{flex:1}} tabLabel={tabLabel}>
                <MYyouhuijuanList {...this.props}  status={status} pageId={'Collection'+type} userInfo={this.props.userInfo}/>
            </View>
        )
    }
    render(){
